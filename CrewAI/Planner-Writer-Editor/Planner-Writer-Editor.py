...
planner = Agent(
    ...
    backstory="You're working on planning a blog article "
              ...
              "You can add suggestions if something is missing"
              "A mermaid diagram is expected with the final text",
...
writer = Agent(
    ...
    backstory="You're working on a writing "
              ...
              "A mermaid diagram of the article writing plan will be outputed with the final text",
    allow_delegation=False,
    verbose=True,
    llm=llm
)
